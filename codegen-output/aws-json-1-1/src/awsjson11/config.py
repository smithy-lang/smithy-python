...
_ServiceInterceptor = Union[
    ...
    Interceptor[EmptyOperationInput, EmptyOperationOutput, Any, Any],
    ...
    Interceptor[KitchenSinkOperationInput, KitchenSinkOperationOutput, Any, Any],
    Interceptor[NullOperationInput, NullOperationOutput, Any, Any],
    Interceptor[
        OperationWithOptionalInputOutputInput,
        OperationWithOptionalInputOutputOutput,
        Any,
    ...
    Interceptor[
        PutAndGetInlineDocumentsInput, PutAndGetInlineDocumentsOutput, Any, Any
    ],
...
class AsyncJsonProtocolConfig(AsyncAwsConfig):
    """Json Protocol configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(
            default=None, resolver=EndpointUriResolver("json_protocol")
        ),
        "endpoint_resolver": FieldSpec(
            default_factory=lambda: StandardRegionalEndpointsResolver(
                endpoint_prefix="jsonprotocol"
            )
        ),
        "protocol": FieldSpec(
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncJsonProtocolConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncJsonProtocolConfig], None]
"""
