...
@dataclass(kw_only=True, frozen=True, slots=True)
class OutputContext[Request, Response, TransportRequest, TransportResponse]:
    request: Request
    """The modeled request for the operation being invoked."""
...
@dataclass(kw_only=True, frozen=True, slots=True)
class RequestContext[Request, TransportRequest]:
    request: Request
    """The modeled request for the operation being invoked."""
...
@dataclass(kw_only=True, frozen=True, slots=True)
class ResponseContext[Request, TransportRequest, TransportResponse]:
    request: Request
    """The modeled request for the operation being invoked."""
...
class InterceptorChain(AnyInterceptor):
    def __init__(self, chain: Iterable[AnyInterceptor]) -> None:
